...
/**
 * Deferred-widget counterpart to RecoversFromReadFailure. The pages are shells and
 * their heavy reads live in #[Lazy] widgets, so the widgets need the same net: any
 * failure while reading the data is logged on the analytics channel
